...
import com.radio.service.AuthPService;
...
@Controller
@AllArgsConstructor
@RequestMapping("/AuthPlaylist/*")
@Log4j
public class AuthPlaylistController {
	
	private AuthPService service;
...
//	@RequestMapping(value = "/list", method = RequestMethod.GET)
	...
	*/
	...
	public void list(@ModelAttribute("cri") Criteria cri, Model model) {
		List<AuthPboardVO> list = service.getList(cri);
...
//	@RequestMapping(value = "/register", method = RequestMethod.POST)
	...
	public String register(AuthPboardVO board, RedirectAttributes rttr) {
...
//		return "board/list";
	...
	public void get(@RequestParam("bno") Long bno,
		...
		*/
		...
		log.info(cri);
		AuthPboardVO vo = service.get(bno);
...
//		model.addAttribute("cri", cri);
	...
	*/
	...
	@PostMapping("/modify")
	public String modify(AuthPboardVO board, Criteria cri, RedirectAttributes rttr) {
		/** 스프링 없이
		BoardVO board = new BoardVO();
	...
	@PostMapping("/modify2")
	public String modify2(AuthPboardVO board, RedirectAttributes rttr) {
		/** 스프링 없이
		BoardVO board = new BoardVO();
		board.setBno(request.getParameter("bno"));
		board.setTitle(request.getParameter("title"));
